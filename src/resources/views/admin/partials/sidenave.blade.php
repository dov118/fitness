<nav class="menu" aria-labelledby="menu-heading">
    ...
    <a class="menu-item" @if('admin.group.index' === Route::current()->getName()) aria-current="page" @endif href="{{ route('admin.group.index') }}"><span class="Counter">{{ count($groups ?? []) ?: '??' }}</span>  Groups</a>
</nav>
