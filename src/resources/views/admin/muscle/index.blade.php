    ...
    <div class="Box Box--condensed">
        ...
        @foreach($muscles as $muscle)
            <div class="Box-row d-flex flex-items-center">
                <div class="flex-auto">
                    <a href="{{ route('admin.muscle.show', $muscle) }}" class="Link Link--primary"><strong>{{ $muscle->name }}</strong></a>
                ...
                <div class="d-flex flex-justify-end">
                    ...
                    <form method="post" action="{{ route('admin.muscle.destroy', $muscle) }}">
                        @csrf
                        @method('delete')
                        <button href="{{ route('admin.muscle.destroy', $muscle) }}" type="button" class="btn btn-danger ml-2" name="button">
